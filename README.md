...
课表 · 上下课铃声 · 番茄钟 · 锁屏专注 · 背景音乐 · 备忘录中心 · 倒数日 · 学习资料库 · 专注统计 · 专注花园 · 深呼吸 · 喝水/健康提醒
...
### 📚 学习资料库（书架升级版）
- 添加 PDF / 电子书 / Word / PPT / Excel 等，按**分类 / 状态 / 收藏 / 标签**整理，卡片按扩展名上色
...
- 明暗主题 + 6 种预设强调色 + **任意自定义强调色**（取色器随便挑）+ **自定义应用背景图**（不透明度 0–100% 可调）
